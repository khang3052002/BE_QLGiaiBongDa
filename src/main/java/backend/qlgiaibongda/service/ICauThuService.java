...
public interface ICauThuService {
    ...
    ResponseEntity<ResponeObject> searchAllPlayerByNameOrRole(String keyword, String roles, Integer page, Integer limit);

    ResponseEntity<ResponeObject> getPlayerFree();
}
